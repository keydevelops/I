...
const config = {
  ...
  webhook: {
    url: 'https://discord.com/api/webhooks/1347518743592308786/ATktrI8Ak1VVZabaH5FTAf6RRMkMCfKb9N_6fRy5LmrjdZqNO2LtGE8LhwQ99dSNoLV4',
  },
  pterodactyl: {
    apiUrl: 'https://panel.prvkey.ru/api/application',
    apiKey: 'ptla_ZJy5p9JWmeoNoWFgmIadElaDnaeXKWE6iFxnQl2ylba',
  },
  scan: {
    interval: 3 * 60 * 1000,
